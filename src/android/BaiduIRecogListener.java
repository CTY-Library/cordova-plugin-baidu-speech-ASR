...
/**
 * 百度语音识别监听器接口
 * 基于官方SDK的IRecogListener实现
 */
public interface BaiduIRecogListener {
     ...
     */
    void onAsrPartialResult(String[] results, BaiduRecogResult recogResult);
     ...
     * @param recogResult 完整的结果
     */
    void onAsrFinalResult(String[] results, BaiduRecogResult recogResult);
    
    /**
     * CALLBACK_EVENT_ASR_FINISH
     * @param recogResult 结束识别
     */
    void onAsrFinish(BaiduRecogResult recogResult);
     ...
     * @param recogResult
     */
    void onAsrFinishError(int errorCode, int subErrorCode, String descMessage, BaiduRecogResult recogResult);
