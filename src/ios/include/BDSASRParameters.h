...
extern NSString* BDS_ASR_PARAM_KEY_API_KEY;
extern NSString* BDS_ASR_IAM_APIKEY;
extern NSString* BDS_ASR_ACCESS_TOKEN;
...
/*
 * BDS_ASR_AUDIO_FILE_RATE
 * Value explanation:   audio file rate
 * Value type:          int
 * Default value:       0
 */
extern NSString* BDS_ASR_AUDIO_FILE_RATE;
